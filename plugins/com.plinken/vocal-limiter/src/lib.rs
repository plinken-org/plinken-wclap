...
/// the lookahead reducer to catch sibilants and pops, short enough that
/// the limiter stays "audible" in the musical sense vocals want, instead
/// of disappearing under the signal like a mastering brick.
