...
```sh
pnpm --filter @plinken/brick-limiter install
pnpm --filter @plinken/brick-limiter build
```

Output: `dist/brick-limiter.wclap.tar.gz`.

## Shipping to the wclap-host shelf

Copy the tarball into
`apps/wclap-host/public/samples/com.plinken.brick-limiter.wclap.tar.gz`
